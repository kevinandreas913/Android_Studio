package com.ak222102468.recyclerviewb;
...
public class AddMahasiswaActivity extends AppCompatActivity {
    ...
    private Spinner _jenisKelaminSpinner, _jpSpinner, _statusMenikahSpinner;
    ...
    private void initSaveButton() {
        ...
        _saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String statusPernikahan = _statusMenikahSpinner.getSelectedItem().toString();
    ...
    private void initInputs() {
        ...
        _statusMenikahSpinner = findViewById(R.id.statusNikahSpinner);
